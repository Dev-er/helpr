...
@Entity
@Table(name = "usuarios") //coloca um nome específico na tabelagit remote
public abstract class Usuario {
    @Id //Torna o campo abaixo uma PRIMARY KEY
    @GeneratedValue(strategy = GenerationType.IDENTITY) // Preenche o campo id como AUTO_INCREMENT
